<%@ page language="java" import="java.util.*" pageEncoding="UTF-8"%>
 <jsp:include page="../common/header.jsp">
 	 <jsp:param value="编辑文章" name="title"/>
 </jsp:include>
    <div id="wrap">
	...
	<div class="container-fluid">
	 	<div class="page-header">
		  ...
		  <div class="row-fluid">
		    <div class="span10">
		    <form action="passageAdd.action" method="post" id="form1" class="form-horizontal">
		   		
	    	<div  class="control-group">
	    		<label  class="control-label">文章标题</label>
	    		<div class="controls">
	    			<input type="text"   class="input-xxlarge" placeholder="输入你的标题"  name="title" value="${psinfo.title}"/>
	    		</div>
		    </div>
		    <div  class="control-group">
